...
import static io.libcodec.json.util.JDKUtils.*;
...
') to determine the total number of lines in the stream.
    ...
    public static int writeInt64(byte[] buf, int off, long val) {
        ...
        int v, v1, v2, v3;
        long numValue = val;
        val = Math.multiplyHigh(numValue, 0x68db8bac710cb296L) >> 12; // val = numValue / 10000;
        v1 = (int) (numValue - val * 10000);
        numValue = val;
        val = Math.multiplyHigh(numValue, 0x68db8bac710ccL); // val = numValue / 10000;
