...
import io.libcodec.internal.Fnv;
import io.libcodec.json.JSONException;
import io.libcodec.json.JSONGenerator;
import io.libcodec.json.annotation.JSONField;
import io.libcodec.json.annotation.JSONType;
import io.libcodec.json.serde.Serializer;
import io.libcodec.meta.BeanInfo;
import io.libcodec.meta.FieldInfo;
...
public abstract class BeanUtils {
    static boolean isUseJacksonAnnotation() {
        return true;
    }
    ...
    public static Constructor getDefaultConstructor(Class objectClass, boolean includeNoneStaticMember) {
        if ((objectClass == StackTraceElement.class) || (isRecord(objectClass))) {
            return null;
        }
        ...
        for (Annotation annotation : annotations) {
            ...
            switch (name) {
                ...
                case "com.fasterxml.jackson.annotation.JsonFormat":
                    boolean useJacksonAnnotation = isUseJacksonAnnotation();
                    ...
                    for (Enum feature : serializeFeatures) {
                        switch (feature.name()) {
                            case "WriteMapNullValue":
                                beanInfo.writerFeatures |= JSONGenerator.Feature.WriteNulls.mask;
                                break;
                            case "WriteNullListAsEmpty":
                                beanInfo.writerFeatures |= JSONGenerator.Feature.WriteNullListAsEmpty.mask;
                                break;
                            case "WriteNullStringAsEmpty":
                                beanInfo.writerFeatures |= JSONGenerator.Feature.WriteNullStringAsEmpty.mask;
                                break;
                            case "WriteNullNumberAsZero":
                                beanInfo.writerFeatures |= JSONGenerator.Feature.WriteNullNumberAsZero.mask;
                                break;
                            case "WriteNullBooleanAsFalse":
                                beanInfo.writerFeatures |= JSONGenerator.Feature.WriteNullBooleanAsFalse.mask;
                                break;
                            case "BrowserCompatible":
                                beanInfo.writerFeatures |= JSONGenerator.Feature.BrowserCompatible.mask;
                                break;
                            case "WriteClassName":
                                beanInfo.writerFeatures |= JSONGenerator.Feature.WriteClassName.mask;
                                break;
                            case "WriteNonStringValueAsString":
                                beanInfo.writerFeatures |= JSONGenerator.Feature.WriteNonStringValueAsString.mask;
                                break;
                            case "WriteEnumUsingToString":
                                beanInfo.writerFeatures |= JSONGenerator.Feature.WriteEnumUsingToString.mask;
                                break;
                            case "NotWriteRootClassName":
                                beanInfo.writerFeatures |= JSONGenerator.Feature.NotWriteRootClassName.mask;
                                break;
                            case "IgnoreErrorGetter":
                                beanInfo.writerFeatures |= JSONGenerator.Feature.IgnoreErrorGetter.mask;
                                break;
                            default:
                                break;
                        }
                ...
                switch (name) {
                    ...
                    case "shape": {
                        ...
                        if ("STRING".equals(shape)) {
                            fieldInfo.features |= JSONGenerator.Feature.WriteNonStringValueAsString.mask;
                ...
                if ("value".equals(name)) {
                    ...
                    switch (include) {
                        case "ALWAYS":
                            ...
                            break;
                        case "NON_DEFAULT":
                            beanInfo.writerFeatures |= JSONGenerator.Feature.NotWriteDefaultValue.mask;
                            break;
                        case "NON_EMPTY":
                            beanInfo.writerFeatures |= JSONGenerator.Feature.NotWriteEmptyArray.mask;
                            break;
                        default:
                            break;
                    }
        ...
        BeanUtils.annotationMethods(annotationClass, m -> {
            ...
            try {
                ...
                if ("value".equals(name)) {
                    ...
                    switch (include) {
                        case "ALWAYS":
                            fieldInfo.features |= JSONGenerator.Feature.WriteNulls.mask;
                            break;
                        case "NON_DEFAULT":
                            fieldInfo.features |= JSONGenerator.Feature.NotWriteDefaultValue.mask;
                            break;
                        case "NON_EMPTY":
                            fieldInfo.features |= JSONGenerator.Feature.NotWriteEmptyArray.mask;
                            fieldInfo.features |= JSONGenerator.Feature.IgnoreEmpty.mask;
                            break;
                        default:
                            break;
                    }
