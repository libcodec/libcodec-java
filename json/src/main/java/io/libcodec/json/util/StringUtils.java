...
import static io.libcodec.json.util.IOUtils.*;
import static io.libcodec.json.util.JDKUtils.ARRAY_BYTE_BASE_OFFSET;
import static io.libcodec.json.util.JDKUtils.UNSAFE;
...
public class StringUtils {
    ...
    public static void writeEscapedChar(char[] chars, int off, int c0) {
        putIntUnaligned(chars, off, UTF16.ESCAPED_CHARS[c0 & 0x7f]);
    }
    ...
    public static void writeU4HexU(char[] chars, int off, int c) {
        putIntUnaligned(chars, off, UTF16.U2);
