...
public class TextIOTest {
    ...
    public void testWriteInt_positiveNumbers_byteArray() {
        ...
        // Test four digits
        newOffset = TextIO.writeInt(buffer, 0, 4567);
        ...
        // Test five digits
        newOffset = TextIO.writeInt(buffer, 0, 12345);
    ...
    public void testWriteInt_edgeCases_byteArray() {
        ...
        // Test zero
        int newOffset = TextIO.writeInt(buffer, 0, 0);
        assertEquals(3, newOffset); // New offset should be 3 (0 + 3)
        assertEquals('0', buffer[0]);

        // Test maximum integer value
        newOffset = TextIO.writeInt(buffer, 0, Integer.MAX_VALUE);
        ...
        newOffset = TextIO.writeInt(buffer, 0, Integer.MIN_VALUE);
    ...
    public void testWriteInt_withOffset_byteArray() {
        ...
        int newOffset = TextIO.writeInt(buffer, 5, 123);
